...
def merge_sections_node(state: State) -> State:
    # Opcional: puedes excluir raw_data y company_description si no quieres repetirlos.
    keys_to_include = [
        'executive_summary', 'project_team', 'product_description', 'market_analysis',
        'marketing_plan', 'production_plan', 'organization_personnel', 'investment_plan',
        'income_cashflow_forecast', 'financial_plan', 'legal_aspects', 'risk_assessment',
        'contingency_coverage', 'csr'
    ]
